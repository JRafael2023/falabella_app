...
import 'componenteobjetivo_model.dart';
export 'componenteobjetivo_model.dart';

class ComponenteobjetivoWidget extends StatefulWidget {
  const ComponenteobjetivoWidget({
    super.key,
    String? tipomatriz,
    String? nemeProyect,
    String? codigo,
  ...
  @override
  State<ComponenteobjetivoWidget> createState() =>
      _ComponenteobjetivoWidgetState();
}

class _ComponenteobjetivoWidgetState extends State<ComponenteobjetivoWidget> {
  late ComponenteobjetivoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponenteobjetivoModel());
