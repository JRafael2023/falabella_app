...
import 'observation_scope_widget.dart' show ObservationScopeWidget;
...
class ObservationScopeModel extends FlutterFlowModel<ObservationScopeWidget> {
  List<ObservationScope> listObservationScope = [];
  ...
  String? _txtnombreTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) return 'Escribe ';
    return null;
  }
  @override
