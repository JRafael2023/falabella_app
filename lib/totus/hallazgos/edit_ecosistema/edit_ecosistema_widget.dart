...
import 'edit_ecosistema_model.dart';
export 'edit_ecosistema_model.dart';

class EditEcosistemaWidget extends StatefulWidget {
  const EditEcosistemaWidget({
    super.key,
    bool? conexion,
    this.idEcosistema,
    this.nombre,
  ...
  final bool conexion;
  final String? idEcosistema;
  final String? nombre;
  final Future Function(List<EcosistemaStruct> listEcosistema)? update;

  @override
  State<EditEcosistemaWidget> createState() => _EditEcosistemaWidgetState();
}
...
class _EditEcosistemaWidgetState extends State<EditEcosistemaWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditEcosistemaModel());
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (nombreDuplicado) {
                                    _mostrarError('Ya existe un ecosistema con el nombre "$nombreNuevo"');
                                    return;
                                  }

                                  _model.estaconectado = await actions.checkInternetConecction();
                                  if (_model.estaconectado!) {
                                    _model.updateEcosistema = await EcosystemsTable().update(
                                      data: {
                                        'name': nombreNuevo,
                                    ...
                                    await DBEcosistema.updateEcosistema(
                                      EcosistemaStruct(
                                        idEcosistema: widget!.idEcosistema,
                                        nombre: nombreNuevo,
                                  ...
                                  await widget.update?.call(_model.listEcosistema);
                                  safeSetState(() {});
                                },
                                text: 'Guardar',
